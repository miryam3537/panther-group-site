...
function getItemClass(index: number): string {
  ...
  if (pos === 3) return "col-span-2";               // wide landscape
  return "";                                         // standard
}
        ...
        <Container>
          ...
          <div className="flex items-end justify-between gap-4" dir="rtl">
            <div>
              ...
              <h1 className="mt-2 text-4xl font-black text-white sm:text-5xl lg:text-6xl">
                {title}
              </h1>
            </div>
            <Link
        ...
        <Container>
          <div className="grid grid-cols-3 gap-2 sm:gap-3">
            {placeholderImages.map((n, i) => (
              ...
              >
                {/* Placeholder gradient — replace with next/image when Supabase is ready */}
                <div
