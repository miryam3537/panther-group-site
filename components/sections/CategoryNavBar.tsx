...
const iconMap: Record<string, React.ReactNode> = {
  ...
  print: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.38-4.171.34 4.171M3.75 18.75h16.5a.75.75 0 00.75-.75V8.25a.75.75 0 00-.75-.75H3.75a.75.75 0 00-.75.75v9.75c0 .414.336.75.75.75zM6.75 4.5h10.5a.75.75 0 01.75.75v3H6v-3a.75.75 0 01.75-.75z" />
    </svg>
  ),
  digital: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8" aria-hidden="true">
...
const shortDescriptions: Record<string, string> = {
  branding:     "מיתוג לעסקים ומוסדות",
  promotions:   'הפקות קד"מ ומתנות',
  events:       "הפקת אירועים מקצה לקצה",
  print:        "ניירת, ספרים, משי ורקמה",
  digital:      "אתרים, דפי נחיתה ובאנרים",
  signage:      "שילוט לעסקים ומוסדות",
  distribution: "הפצה לתיבות דואר ותלי דלת",
  posters:      "הדבקת מודעות ולוחות פרסום",
};
